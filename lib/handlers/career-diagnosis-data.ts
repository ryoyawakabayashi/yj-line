 ...
 *
 * ラベル制約: 「A: xxx」全体で12文字以内（LINE QRボタン表示用）
 */
...
export const CAREER_TYPES: Record<string, CareerTypeInfo> = {
  GARJ: {
    ...
    description: {
      ja: 'チームワークが好きで、体を動かしながら、決まった仕事をコツコツできる。日本語も使いたい人。',
  ...
  GARO: {
    ...
    description: {
      ja: 'チームで体を動かして、決まった仕事をやりたい人。日本語は少なくてもOK。',
  ...
  GAVJ: {
    ...
    description: {
      ja: 'チームで働き、体を動かしながら、毎日違う仕事を楽しめる人。日本語OK。',
  ...
  GAVO: {
    ...
    description: {
      ja: 'チームで体を動かし、変化ある仕事が好き。日本語なしでも大丈夫。',
  ...
  GDRJ: {
    ...
    description: {
      ja: 'チームでデスクワーク中心、決まった仕事をコツコツ。日本語使いたい人。',
  ...
  GDRO: {
    ...
    description: {
      ja: 'チームでデスクワーク、ルーティンが好き。日本語は少なくてOK。',
  ...
  GDVO: {
    ...
    description: {
      ja: 'チームでデスクワーク、変化ある仕事が好き。日本語なしでもOK。',
  ...
  LARJ: {
    ...
    description: {
      ja: '一人で体を動かし、決まった仕事をコツコツ。日本語使いたい。',
  ...
  LARO: {
    ...
    description: {
      ja: '一人で体を動かし、決まった仕事を黙々と。日本語少なくてOK。',
  ...
  LAVO: {
    ...
    description: {
      ja: '一人で体を動かし、変化ある仕事が好き。日本語なしでもOK。',
  ...
  LDRJ: {
    ...
    description: {
      ja: '一人でデスクワーク、決まった仕事をコツコツ。日本語使いたい。',
  ...
  LDRO: {
    ...
    description: {
      ja: '一人でデスクワーク、決まった仕事を集中。日本語少なくてOK。',
  ...
  LDVO: {
    ...
    description: {
      ja: '一人でデスクワーク、変化ある仕事が好き。日本語なしでもOK。',
