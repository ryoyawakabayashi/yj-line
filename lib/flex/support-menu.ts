...
const TEXTS = {
  ...
  th: {
    ...
    bugDesc: 'รายงานข้อผิดพลาดหรือปัญหา',
    altText: 'เมนูติดต่อ',
    yoloJapan: 'YOLO JAPAN',
    yoloDiscover: 'YOLO DISCOVER',
    yoloHome: 'YOLO HOME',
  ...
  id: {
    ...
    bug: 'Laporan Bug',
    bugDesc: 'Laporkan kesalahan atau masalah',
    altText: 'Menu Kontak',
    yoloJapan: 'YOLO JAPAN',
    yoloDiscover: 'YOLO DISCOVER',
    yoloHome: 'YOLO HOME',
  ...
  pt: {
    ...
    bug: 'Reportar Erro',
    bugDesc: 'Reportar erros ou problemas',
  ...
  es: {
    ...
    bug: 'Reportar Error',
    bugDesc: 'Reportar errores o problemas',
  ...
  ne: {
    ...
    bug: 'बग रिपोर्ट',
    bugDesc: 'त्रुटि वा समस्या रिपोर्ट गर्नुहोस्',
  ...
  my: {
    ...
    bugDesc: 'အမှားများ သို့မဟုတ် ပြဿနာများကို အစီရင်ခံပါ',
